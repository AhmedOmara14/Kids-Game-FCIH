...
import 'package:multimedia/ui/leveltwo/Daal.dart';

Daal obj = new Daal();

class khaa2 extends StatelessWidget {
  @override
...
class _MyHomeState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    ),child: Center(child: Text('خ', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
                        ...
                        child: Row(
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage: AssetImage('Images/sheep.png'),
                              radius: 100.0,
                            ),
                            Container(
