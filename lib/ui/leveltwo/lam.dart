...
import 'package:multimedia/ui/leveltwo/meme.dart'; // file name of the next char

meme obj = new meme();  // class name of the next char
...
class _MyHomeState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    ),child: Center(child: Text('ل', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('ي', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('م', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('و', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('ن', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
                        ...
                        child: Row(
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage: AssetImage('Images/lemon.png'),
                              radius: 100.0,
                            ),
                            Container(
