...
import 'package:multimedia/ui/leveltwo/faa2.dart';

faa2 obj = new faa2();

class gheen extends StatelessWidget {
  @override
...
class _MyHomeState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    ),child: Center(child: Text('غ', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('ز', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
                        ...
                        child: Row(
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage: AssetImage('Images/deer.png'),
                              radius: 100.0,
                            ),
                            Container(
