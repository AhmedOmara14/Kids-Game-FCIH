...
import 'package:multimedia/ui/leveltwo/lam.dart';

lam obj = new lam();

class kkaf extends StatelessWidget {
  @override
...
class _MyHomeState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    ),child: Center(child: Text('ك', style: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
