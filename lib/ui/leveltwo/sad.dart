...
import 'package:multimedia/ui/leveltwo/dad.dart'; // file name of the next char

dad obj = new dad();  // class name of the next char
...
class _MyHomeState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    ),child: Center(child: Text('ص', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('د', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('ق', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
