...
import 'package:multimedia/ui/leveltwo/raa2.dart';

raa2 obj = new raa2();

class Zaal extends StatelessWidget {
  @override
...
class _MyHomeState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    ),child: Center(child: Text('ذ', style: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('ئ', style: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('ب', style: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
