...
import 'package:multimedia/ui/leveltwo/Geem.dart';

Geem obj = new Geem();

class Thaa2 extends StatelessWidget {
  @override
...
class _MyHomeState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    ),child: Center(child: Text('ث', style: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('ع', style: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('ل', style: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('ب', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: (){
                          if(accepted1==true && accepted2 == true && accepted3 == true && accepted4 == true){
                            player.play('ثعلب.mp3');
