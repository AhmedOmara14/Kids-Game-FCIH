...
import 'package:multimedia/ui/leveltwo/sheen.dart';
...
class _MyHomeState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    ),child: Center(child: Text('س', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('ك', style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
