...
import 'package:multimedia/ui/main/main.dart';

menu obj = new menu();

class yaa2 extends StatelessWidget {
  @override
...
class _MyHomeState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    ),child: Center(child: Text('ي', style: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
    ...
    ),child: Center(child: Text('د', style: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.white,),),),);
                  ...
                  children: <Widget>[
                        ...
                        child: Row(
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage: AssetImage('Images/hand.png'),
                              radius: 100.0,
                            ),
                            Container(
                    ...
                    Container(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: (){
                          if(accepted1==true && accepted2 == true){
                            player.play('يد.mp3');
